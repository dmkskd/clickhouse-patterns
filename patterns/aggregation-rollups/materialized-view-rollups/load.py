...
That split is the point of this pattern. candles_1m therefore holds several
partial aggregate states for the same (symbol, minute); reading them with the
-Merge combinators recombines them into the correct candle, proving the rollup
is independent of how the inserts were batched.
"""
...
# Each inner list is one INSERT -> one block -> one part -> one MV firing.
BATCHES = [
